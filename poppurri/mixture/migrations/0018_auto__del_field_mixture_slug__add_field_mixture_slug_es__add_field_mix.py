...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mixture.slug_es'
        db.add_column(u'mixture_mixture', 'slug_es',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Mixture.slug_en'
        db.add_column(u'mixture_mixture', 'slug_en',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Mixture.slug_es'
        db.delete_column(u'mixture_mixture', 'slug_es')

        # Deleting field 'Mixture.slug_en'
        db.delete_column(u'mixture_mixture', 'slug_en')
