...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recipe.amount'
        db.alter_column(u'mixture_recipe', 'amount', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Recipe.amount'
        db.alter_column(u'mixture_recipe', 'amount', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
