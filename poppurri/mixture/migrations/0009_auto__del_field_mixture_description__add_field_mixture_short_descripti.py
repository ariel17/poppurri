...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mixture.description'
        db.delete_column(u'mixture_mixture', 'description')
    ...
    def backwards(self, orm):
        # Adding field 'Mixture.description'
        db.add_column(u'mixture_mixture', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)
