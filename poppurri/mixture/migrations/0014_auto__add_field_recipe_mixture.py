...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipe.mixture'
        db.add_column(u'mixture_recipe', 'mixture',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name=u'recipes', to=orm['mixture.Mixture']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipe.mixture'
        db.delete_column(u'mixture_recipe', 'mixture_id')
    ...
    models = {
        ...
        u'mixture.category': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'children'", 'null': 'True', 'blank': 'True', 'to': u"orm['mixture.Category']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100'})
        },
        u'mixture.mixture': {
            'Meta': {'object_name': 'Mixture'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mixtures'", 'null': 'True', 'to': u"orm['mixture.Category']"}),
