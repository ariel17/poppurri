...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'user_profile_userprofile', (
            ...
            ('picture', self.gf('django.db.models.fields.files.ImageField')(default='img/no-img.png', max_length=100, null=True, blank=True)),
            ...
            ('personal_page_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'user_profile.userprofile': {
            ...
            'personal_page_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'picture': ('django.db.models.fields.files.ImageField', [], {'default': "'img/no-img.png'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
